  ...
  return (
    <Sheet>
      <SheetTrigger asChild>
        <Image src="/icons/hamburger.svg" height={36} width={36} alt="menu" className="invert-colors sm:hidden" />
      </SheetTrigger>
          ...
          <div className="flex flex-col gap-3">
            {userId ? (
              ...
              <Button type="submit" className="base-medium w-fit bg-transparent px-4 py-3">
                ...
                <span className="text-dark_300_light900 dark:text-white ">Logout</span>
              </Button>
            </form>
              </SheetClose>
            ) : (
